...
void HTMLGenerator::sendHomepage(){
	...
	res+="<script src='https://code.jquery.com/jquery-3.1.1.slim.min.js' integrity='sha384-A7FZj7v+d/sdmMqp/nOQwliLvUsJfDHW+k9Omg/a/EheAdgtzNs3hpfag6Ed950n' crossorigin='anonymous'></script>";
	...
	res+="<input type='number' min='0' max='255' class='form-control RGBInput' id='redInput' name='red' placeholder='Enter 0 - 255'>";
	res+="</div>";
	res+="</div>";
	res+="<div class='form-group'>";
	res+="<label class='col-2'>Green:</label>";
	res+="<div class='col-10'>";
	res+="<input type='number' min='0' max='255' class='form-control RGBInput' id='greenInput' name='green' placeholder='Enter 0 - 255'>";
	res+="</div>";
	res+="</div>";
	res+="<div class='form-group'>";
	res+="<label class='col-2'>Blue:</label>";
	res+="<div class='col-10'>";
	res+="<input type='number' min='0' max='255' class='form-control RGBInput' id='blueInput' name='blue' placeholder='Enter 0 - 255'>";
	res+="</div>";
	res+="</div>";
	res+="<div class='form-group'>";
	...
	res+="<div class='form-group'>";
	res+="<div class='col-10'>";
	res+="<button type='submit' class='btn btn-primary btn-block'>Submit</button>";
	res+="</div>";
	res+="</div>";
	res+="</form>";
	res+="</div>";
	...
	res+="<div class='col-10'>";
	res+="<input id='startCheckBox' type='checkbox' checked data-toggle='toggle'>";
	res+="</div>";
	res+="</div>";
	res+="</form>";
	res+="</div>";
	...
	res+="<a href='#' class='list-group-item active'>Play Example</a>";
	res+="<a href='#' class='list-group-item list-group-item-action disabled'>Color Wipe</a>";
	res+="<a href='#' class='list-group-item list-group-item-action disabled'>Set Fire to the rain!</a>";
	res+="<a href='#' class='list-group-item list-group-item-action disabled'>Rainbow cycle</a>";
	res+="<a href='#' class='list-group-item list-group-item-action disabled'>Snow sparkle</a>";
	res+="<a href='#' class='list-group-item list-group-item-action disabled'>Twinkle</a>";
	res+="</div>";
	res+="</form>";
	res+="</div>";
	res+="</div>";
